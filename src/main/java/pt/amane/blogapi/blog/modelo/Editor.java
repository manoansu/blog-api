...
public class Editor {
    ...
    public void atualizarComDados(Editor editor) {
        ...
        this.nome = editor.getNome();
        this.email = editor.getEmail();
        this.valorPagoPorPalavra = editor.getValorPagoPorPalavra();
        this.premium = editor.isPremium();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Editor editor)) return false;
        return id.equals(editor.id);
    }
